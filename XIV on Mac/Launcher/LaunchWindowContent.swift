        ...
        VStack
        {
            HStack
            {
                CarouselView(index: $carouselIndex.animation(), maxIndex: launchController.banners.count)
                {
                    ...
                    {
                        ForEach($launchController.banners)
                        { $oneBanner in
                ...
                VStack
                {
                    ...
                    HStack
                    {
                        ...
                        Menu
                        {
                            ...
                            {
                                ForEach(LoginCredentials.accounts)
                                { oneAccount in
            ...
            HStack
            {
                ...
                ScrollView
                {
                    LazyVStack(alignment:.leading)
                    {
                        ForEach($launchController.topics)
                        { $oneTopic in
                            HStack
                            {
