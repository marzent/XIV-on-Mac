...
extension HTTPClient {
    ...
    static func fetch(url: URL, headers: OrderedDictionary<String, String?>?, postBody: Data = Data()) -> Response? {
    ...
    static func fetchFile(url: URL, destinationUrl: URL? = nil, headers: OrderedDictionary<String, String>? = nil, proxy: String? = nil, progressCallback: ((Int64, Int64, Int64) -> Void)? = nil) throws {
        ...
        if response == 200 {
            ...
            Log.error("Invalid response \(response) for file download \(url)!\n")
