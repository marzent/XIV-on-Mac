...
class InstallerController: NSViewController , ObservableObject {
    ...
    @Published var page : InstallerSheetPage = InstallerSheetPage(rawValue:0)! // You can set this to another value to see that page in the SwiftUI preview without breaking the flow
