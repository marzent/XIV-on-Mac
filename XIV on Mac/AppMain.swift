...
@main class XIVOnMac: App
{
    ...
    private var firstAidWindow : FirstAidWindowContent = FirstAidWindowContent()
    private var launchController : LaunchController = LaunchController()
    ...
    var body: some Scene
    {
        ...
        .commands
        {
            ...
            CommandMenu("MENU_INSTALL")
            {
                ...
                Menu("MENU_GSHADE")
                {
                    Button("MENU_GSHADE_AUTO")
                    {
                        self.appDelegate.installGShade(self)
                    }
                    Button("MENU_GSHADE_MANUAL")
                    {
                        self.appDelegate.manualGShade(self)
                    }
                }
            }
        }
...
class AppDelegate: NSObject, NSApplicationDelegate, SPUUpdaterDelegate, ObservableObject {
    ...
    func installGShade(_ sender: Any) {
        GShade.install()
    }
    
    func manualGShade(_ sender: Any) {
        GShade.manual()
    }
    ...
    func dxvkSettings(_ sender: Any) {
    }
