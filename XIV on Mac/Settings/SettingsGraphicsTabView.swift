...
struct SettingsGraphicsTabView: View
{
    ...
    @State var fpsLimit : String = String(Dxvk.options.maxFramerate)
    ...
    var mapping : [String:Bool] = [String:Bool]()
